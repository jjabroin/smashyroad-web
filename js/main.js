...
import { TRACK_DEFS, buildTrack, trackY } from './track.js?v=d8bb15';
import {
...
} from './race.js?v=b6af4a';
import { CAR_BUILDERS } from './voxel.js?v=35aa4d';
import { createWorld, gridSlots, ROAD_HALF } from './world.js?v=dc5a38';

...
function track9Points() {
  ...
  // 탈출: 남쪽으로 나와 동쪽으로 크게 우회 (역주행 겹침 금지)
  // 이후 북상·라이저는 콘크리트 튜브로 은폐 (주행 안 함)
  pts.push([-38, 20], [-38, 60], [0, 80], [60, 40], [60, -60], [0, -140], [-20, -140]);
  return pts;
}
...
export const TRACK_DEFS = [
  ...
  },
  {
    ...
    hill: { amp: 14, k: 3 }, boosts: [0.2, 0.5, 0.8], jumps: [0.65], blocks: [0.5],
    points: [
  ...
  },
  {
    ...
    hill: { amp: 8, k: 3 }, boosts: [0.3, 0.7], jumps: [0.4], blocks: [0.2, 0.6],
    points: [
  ...
  },
  {
    ...
    hill: { amp: 10, k: 4 }, boosts: [0.35, 0.75], jumps: [0.5, 0.85], blocks: [0.3, 0.65],
    points: [
  ...
  },
  {
    ...
    hill: { points: [
      [0, 72], [0.0405, 72],
      [0.1284, 64], [0.2163, 56], [0.3043, 48], [0.3922, 40], [0.4801, 32],
      [0.5680, 24], [0.6559, 16], [0.7438, 8], [0.8318, 0],
      [0.8796, 0], [0.895, -25], [0.97, -25], [1, 72],
    ] },
    overlap3d: true,
    finishU: 0.8796,
